...
import com.mojang.minecraft.render.c;
...
public class Block {
   ...
   public void a(c var1, int var2, int var3, int var4, int var5) {
   ...
   public final void b(c var1, int var2, int var3, int var4, int var5) {
      int var6;
      float var7;
   ...
   public final MovingObjectPosition a(int var1, int var2, int var3, com.mojang.minecraft.model.c var4, com.mojang.minecraft.model.c var5) {
      var4 = var4.a((float)(-var1), (float)(-var2), (float)(-var3));
      var5 = var5.a((float)(-var1), (float)(-var2), (float)(-var3));
      com.mojang.minecraft.model.c var6 = var4.a(var5, this.ae);
      com.mojang.minecraft.model.c var7 = var4.a(var5, this.ah);
      com.mojang.minecraft.model.c var8 = var4.b(var5, this.af);
      com.mojang.minecraft.model.c var9 = var4.b(var5, this.ai);
      com.mojang.minecraft.model.c var10 = var4.c(var5, this.ag);
      ...
      com.mojang.minecraft.model.c var11 = null;
      if(var6 != null) {
         var11 = var6;
      }
   ...
   public boolean a(Level var1, int var2, int var3, int var4, c var5) {
      boolean var6 = false;
      float var7 = 0.5F;
      float var8 = 0.8F;
      float var9 = 0.6F;
